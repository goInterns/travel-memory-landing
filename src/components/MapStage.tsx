...
const SCENES: Scene[] = [
  {
    ...
    title: 'Now you\u2019re on the road.',
    body: 'Delhi, before dawn. The saved route is live beneath you — the real map, real terrain, the whole way to the summit.',
    stopIndex: 0,
    progress: 0.02,
    align: 'left',
  },
  {
    ...
    phase: 'Experience',
    eyebrow: '03 — The journey',
    title: 'The first stop you saved.',
    body: 'Murthal, two hours in. The line runs through every place you pinned along the way.',
    stopIndex: 1,
    progress: 0.16,
    align: 'right',
  },
  {
    ...
    phase: 'Experience',
    eyebrow: '03 — The journey',
    title: 'The route unspools north.',
    body: 'A real road route from Delhi through Chandigarh and up into the Dhauladhar \u2014 day by day, terrain and all.',
    stopIndex: 2,
    progress: 0.45,
    align: 'left',
  },
  {
    ...
    body: 'Follow the line as it climbs. This is real elevation \u2014 tilt into the valleys the road carves through.',
    stopIndex: 3,
    progress: 0.78,
    align: 'right',
  },
  {
    ...
    phase: 'Experience',
    eyebrow: '03 — The journey',
    title: 'McLeod Ganj. The last town.',
    body: 'Monastery bells and momos. Beyond here the road ends and the trail to the summit begins.',
    stopIndex: 4,
    progress: 0.9,
    align: 'left',
  },
  {
    ...
    phase: 'Experience',
    eyebrow: '03 — The journey',
    title: 'Triund. The summit.',
    body: 'Where the drive becomes a trek, and the trek becomes the moment you came for.',
    stopIndex: 5,
    progress: 1,
    align: 'right',
  },
  {
    ...
    phase: 'Experience',
    eyebrow: '03 — The journey',
    title: 'Five days. 497 kilometres. One line.',
    body: 'The real terrain, the real route \u2014 held together as one journey. Now, what did you bring back from it?',
    stopIndex: null,
    progress: 1,
    align: 'center',
  },
